...
if (isset($_POST['btnSend'])) {
    ...
    if ((!empty($nome)) && (!empty($email)) && (!empty($telefone)) && (!empty($assunto)) && (!empty($mensagem))) {
        ...
        $email_remetente = "formulario@baudalu.net.br"; // deve ser uma conta de email do seu dominio 
        $email_destinatario = "luiza@baudalu.net.br"; // email que receberá as mensagens
        $email_recebidoDe = "$email";
        $email_assunto = "$assunto de $nome"; // Este será o assunto da mensagem
        $email_conteudo = "FORMULÁRIO DE CONTATO - BAÚ DA LU\n"
            . "<br><b>De:</b> " . $nome
            . "<br><b>Email:</b> " . $email
            ...
            . "<br><br>"
            . "<hr>"
            . "<br>Mensagem enviada por </b> " . $nome . " através do formulário de contato.";
